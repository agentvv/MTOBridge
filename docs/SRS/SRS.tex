...
\item The system will validate the input for the allowed ranges.
...
\subsection{Usability and Humanity Requirements}
  ...
  \noindent\textbf{NFR.?} Program will have a user manual and (user-based) documentation provided.\\
  ...
  \noindent\textbf{NFR.?} (Not sure if usability or look and feel) UI elements which provide similar functionality will have a similar look.\\
