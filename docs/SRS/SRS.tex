...
\textbf{Dead load:} The weight of the permanent, immovable parts of a structure, such as the towers, cables, and roadway of a bridge.\\
...
\emph{  Basic Flow:} 
\begin{itemize}
\item The system receives the configuration data from each tab. 
...
\subsection{Functional Requirements/Phase in Plan}
  ...
  \noindent\textbf{FR.6} The Program should allow the user to define the characteristics of the bridge, including what type of bridge it is and its length.\\
