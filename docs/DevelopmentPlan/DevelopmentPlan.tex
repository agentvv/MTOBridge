...
Although we don't expect that the performance of our code will have much effect on the performance of the project as a whole (the majority of computing resources will be taken up by the MatLab back-end), we will still use Valgrind as a way to check for runtime errors in our code.
